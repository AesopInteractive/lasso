...
class aesopEditorAssets {
	...
	function scripts(){
		...
		wp_enqueue_script('aesop-editor-script', AESOP_EDITOR_URL.'/public/assets/js/content-editable.js', array('jquery'), AESOP_EDITOR_VERSION, true);
