...
<<<<<<< HEAD
<<<<<<< HEAD
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(a){a(document).on("submit",".lasso--post-form",function(b){b.preventDefault();var c=a(this),d=c.find('input[type="submit"]'),e=lasso_editor.strings,f=c.serialize();d.val(e.saving),a.post(lasso_editor.ajaxurl,f,function(a){1==a.success&&(d.val(e.saved).addClass("saved"),console.log(a),setTimeout(function(){d.removeClass("saved"),d.val(e.save)},1e3))})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,x=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Pages(x)):(capable=lasso_editor.edit_others_posts,x=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Posts(x)),v.fetch(x).done(function(){if(a("#lasso--load-more").remove(),v.length>0){var c=v.state.currentPage;c-=1;var g=a('<div data-page-num="'+v.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');v.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(s),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return x={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:8,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',s='<a href="#" id="lasso--load-more">'+n+"</a>",t=1,u="post",v=!1,w=null,x={data:{page:t,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),t++,u=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),t=1,w=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(r),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,x=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Pages(x)):(capable=lasso_editor.edit_others_posts,x=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Posts(x)),v.fetch(x).done(function(){if(a("#lasso--load-more").remove(),v.length>0){var c=v.state.currentPage;c-=1;var g=a('<div data-page-num="'+v.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');v.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(s),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return x={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:8,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',s='<a href="#" id="lasso--load-more">'+n+"</a>",t=1,u="post",v=!1,w=null,x={data:{page:t,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),t++,u=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),t=1,w=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(r),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){if(a(this).val().length>=3){var b={action:"process_search_posts",term:a(this).val(),nonce:lasso_editor.searchPosts};a.post(lasso_editor.ajaxurl,b,function(a){console.log(a),1==a.success&&console.log(a)})}})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 5c73ac3... first pass at ability to search all posts within posts modal
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Pages(y)):(capable=lasso_editor.edit_others_posts,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Posts(y)),v.fetch(y).done(function(){if(a("#lasso--load-more").remove(),v.length>0){var c=v.state.currentPage;c-=1;var g=a('<div data-page-num="'+v.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');v.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(s),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return y={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:8,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',s='<a href="#" id="lasso--load-more">'+n+"</a>",t=1,u="post",v=!1,w=null,x=d.root,y={data:{page:t,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),t++,u=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),t=1,w=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(r),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){var b=a(this).val(),c=x+"/posts?filter[s]="+b;b.length>=4&&a.getJSON(c,function(b){a(l).children().remove(),a.each(b,function(c){a(l).prepend(j({post:b[c],settings:d}))})})})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 413d616... ditch the server side process and roll with REST API endpoint for returning search results
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Pages(y)):(capable=lasso_editor.edit_others_posts,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Posts(y)),v.fetch(y).done(function(){if(a("#lasso--load-more").remove(),v.length>0){var c=v.state.currentPage;c-=1;var g=a('<div data-page-num="'+v.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');v.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(s),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return y={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',s='<a href="#" id="lasso--load-more">'+n+"</a>",t=1,u="post",v=!1,w=null,x=d.root,y={data:{page:t,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),t++,u=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),t=1,w=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(r),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){var b=a(this).val(),c=x+"/posts?filter[s]="+b;b.length>=4&&(a(l).prepend(r),a.getJSON(c,function(b){a(l).children().remove(),a.each(b,function(c){a(l).prepend(j({post:b[c],settings:d}))})}))})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 3bedc74... add loading indicator while getting search results
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Pages(y)):(capable=lasso_editor.edit_others_posts,y=capable?h(b,t):h(b,t,lasso_editor.author),v=new wp.api.collections.Posts(y)),v.fetch(y).done(function(){if(a("#lasso--load-more").remove(),v.length>0){var c=v.state.currentPage;c-=1;var g=a('<div data-page-num="'+v.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');v.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(s),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return y={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',s='<a href="#" id="lasso--load-more">'+n+"</a>",t=1,u="post",v=!1,w=null,x=d.root,y={data:{page:t,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),t++,u=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),t=1,w=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(r),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){var b=a(this).val(),c=x+"/posts?filter[s]="+b;setTimeout(function(){b.length>=3&&(a(l).prepend(r),a.getJSON(c,function(b){a(l).children().remove(),a.each(b,function(c){a(l).prepend(j({post:b[c],settings:d}))})})),""==b&&(a(l).children().remove(),g("post"))},500)})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 316857e... if no value run fetchPosts, put behind a delay so we dont run excessively
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Pages(A)):(capable=lasso_editor.edit_others_posts,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Posts(A)),x.fetch(A).done(function(){if(a("#lasso--load-more").remove(),x.length>0){var c=x.state.currentPage;c-=1;var g=a('<div data-page-num="'+x.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');x.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(u),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(r),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return A={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=lasso_editor.strings.noResultsFound,q=a("body"),r='<li id="lasso--end-posts">'+o+"</li>",s='<li id="lasso--end-posts">'+p+"</li>",t='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',u='<a href="#" id="lasso--load-more">'+n+"</a>",v=1,w="post",x=!1,y=null,z=d.root,A={data:{page:v,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),q.toggleClass("lasso-modal-open"),q.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(q).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),v++,w=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),v=1,y=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(t),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){var b=a(this).val(),c=z+"/posts?filter[s]="+b;setTimeout(function(){b.length>=3&&(a(l).prepend(t),a.getJSON(c,function(b){a(l).children().remove(),0==b.length?a(l).prepend(s):a.each(b,function(c){a(l).prepend(j({post:b[c],settings:d}))})})),""==b&&(a(l).children().remove(),g("post"))},800)})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 22afc72... account for no results, increase delay by 300ms
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(l).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,z=capable?h(b,u):h(b,u,lasso_editor.author),w=new wp.api.collections.Pages(z)):(capable=lasso_editor.edit_others_posts,z=capable?h(b,u):h(b,u,lasso_editor.author),w=new wp.api.collections.Posts(z)),w.fetch(z).done(function(){if(a("#lasso--load-more").remove(),w.length>0){var c=w.state.currentPage;c-=1;var g=a('<div data-page-num="'+w.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');w.each(function(a){g.append(j({post:a.attributes,settings:d}))}),a(l).append(g),a(l).append(t),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(l).append(q),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return z={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i=a("#lasso-tmpl--post"),j=c.template(i.html()),k=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),l="#lasso--post-list",m=lasso_editor.strings.loading,n=lasso_editor.strings.loadMore,o=lasso_editor.strings.noPostsFound,p=a("body"),q='<li id="lasso--end-posts">'+o+"</li>",r=lasso_editor.noResultsDiv,s='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',t='<a href="#" id="lasso--load-more">'+n+"</a>",u=1,v="post",w=!1,x=null,y=d.root,z={data:{page:u,filter:{post_status:["publish","draft","pending"]}}};a(k).on("click",function(a){a.preventDefault(),p.toggleClass("lasso-modal-open"),p.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(p).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(m),u++,v=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),u=1,x=null,a("#lasso--load-more").attr("data-post-type",type),a(l).prepend(s),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){var b=a(this).val(),c=y+"/posts?filter[s]="+b,e=a("#lasso--results-found");setTimeout(function(){b.length>=3&&(a(l).prepend(s),a.getJSON(c,function(b){a(l).children().remove(),e.parent().css("opacity",1),0==b.length?(e.text("0"),a("#lasso--empty-results").length||a(l).prepend(r)):(e.text(b.length),a.each(b,function(c){a(l).prepend(j({post:b[c],settings:d}))}))}))},800),""==b&&(a(l).children().remove(),g("post"),e.parent().css("opacity",0))})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> b4fef48... show how many search results, prep empty state
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(m).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Pages(A)):(capable=lasso_editor.edit_others_posts,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Posts(A)),x.fetch(A).done(function(){if(a("#lasso--load-more").remove(),x.length>0){var c=x.state.currentPage;c-=1;var g=a('<div data-page-num="'+x.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');x.each(function(a){g.append(k({post:a.attributes,settings:d}))}),a(m).append(g),a(m).append(u),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(m).append(r),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return A={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i,j=a("#lasso-tmpl--post"),k=c.template(j.html()),l=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),m="#lasso--post-list",n=lasso_editor.strings.loading,o=lasso_editor.strings.loadMore,p=lasso_editor.strings.noPostsFound,q=a("body"),r='<li id="lasso--end-posts">'+p+"</li>",s=lasso_editor.noResultsDiv,t='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',u='<a href="#" id="lasso--load-more">'+o+"</a>",v=1,w="post",x=!1,y=null,z=d.root,A={data:{page:v,filter:{post_status:["publish","draft","pending"]}}};a(l).on("click",function(a){a.preventDefault(),q.toggleClass("lasso-modal-open"),q.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(q).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(n),v++,w=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),v=1,y=null,a("#lasso--load-more").attr("data-post-type",type),a(m).prepend(t),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){clearTimeout(i);var b=this,c=a(this).val(),e=z+"/posts?filter[s]="+c,f=a("#lasso--results-found");i=setTimeout(function(){c.length>=3&&c==a(b).val()&&(a(m).prepend(t),a.getJSON(e,function(b){a(m).children().remove(),f.parent().css("opacity",1),0==b.length?(f.text("0"),a("#lasso--empty-results").length||a(m).prepend(s)):(f.text(b.length),a.each(b,function(c){a(m).prepend(k({post:b[c],settings:d}))}))}))},800),""==c&&(a(m).children().remove(),g("post"),f.parent().css("opacity",0))})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 6c27398... timer rework, clear the previous timer and ensure vals are the same
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(m).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Pages(A)):(capable=lasso_editor.edit_others_posts,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Posts(A)),x.fetch(A).done(function(){if(a("#lasso--load-more").remove(),x.length>0){var c=x.state.currentPage;c-=1;var g=a('<div data-page-num="'+x.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');x.each(function(a){g.append(k({post:a.attributes,settings:d}))}),a(m).append(g),a(m).append(u),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(m).append(r),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return A={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i,j=a("#lasso-tmpl--post"),k=c.template(j.html()),l=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),m="#lasso--post-list",n=lasso_editor.strings.loading,o=lasso_editor.strings.loadMore,p=lasso_editor.strings.noPostsFound,q=a("body"),r='<li id="lasso--end-posts">'+p+"</li>",s=lasso_editor.noResultsDiv,t='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',u='<a href="#" id="lasso--load-more">'+o+"</a>",v=1,w="post",x=!1,y=null,z=d.root,A={data:{page:v,filter:{post_status:["publish","draft","pending"]}}};a(l).on("click",function(a){a.preventDefault(),q.toggleClass("lasso-modal-open"),q.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(q).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(n),v++,w=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),v=1,y=null,a("#lasso--load-more").attr("data-post-type",type),a(m).prepend(t),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){clearTimeout(i);var b=this,c=a(this).val(),e=z+"/posts?filter[s]="+c,f=a("#lasso--results-found");i=setTimeout(function(){c.length>=3&&c==a(b).val()&&(a(m).prepend(t),a.getJSON(e,function(b){a(m).children().remove(),f.parent().css("opacity",1),0==b.length?(f.text("0"),a("#lasso--empty-results").length||a(m).prepend(s)):(f.text(b.length),a.each(b,function(c){a(m).prepend(k({post:b[c],settings:d}))}))}))},800),""==c&&(a(m).children().remove(),g("post"),f.parent().css("opacity",0))}).on("click","#lasso--search__toggle",function(b){b.preventDefault();var c=a(this),d="lasso--search__visible";c.closest(".lasso--search").toggleClass(d)})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 351b698... styling, add an icon, start as icon, then slide out search on click
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(m).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Pages(A)):(capable=lasso_editor.edit_others_posts,A=capable?h(b,v):h(b,v,lasso_editor.author),x=new wp.api.collections.Posts(A)),x.fetch(A).done(function(){if(a("#lasso--load-more").remove(),x.length>0){var c=x.state.currentPage;c-=1;var g=a('<div data-page-num="'+x.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');x.each(function(a){g.append(k({post:a.attributes,settings:d}))}),a(m).append(g),a(m).append(u),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(m).append(r),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return A={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}var i,j=a("#lasso-tmpl--post"),k=c.template(j.html()),l=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),m="#lasso--post-list",n=lasso_editor.strings.loading,o=lasso_editor.strings.loadMore,p=lasso_editor.strings.noPostsFound,q=a("body"),r='<li id="lasso--end-posts">'+p+"</li>",s=lasso_editor.noResultsDiv,t='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',u='<a href="#" id="lasso--load-more">'+o+"</a>",v=1,w="post",x=!1,y=null,z=d.root,A={data:{page:v,filter:{post_status:["publish","draft","pending"]}}};a(l).on("click",function(a){a.preventDefault(),q.toggleClass("lasso-modal-open"),q.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(q).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(n),v++,w=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),v=1,y=null,a("#lasso--load-more").attr("data-post-type",type),a(m).prepend(t),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){clearTimeout(i);var b=this,c=a(this).val(),e=a(".active.lasso--show-objects").data("post-type"),f=z+"/"+e+"s?filter[s]="+c,h=a("#lasso--results-found");i=setTimeout(function(){c.length>=3&&c==a(b).val()&&(a(m).prepend(t),a.getJSON(f,function(b){a(m).children().remove(),h.parent().css("opacity",1),0==b.length?(h.text("0"),a("#lasso--empty-results").length||a(m).prepend(s)):(h.text(b.length),a.each(b,function(c){a(m).prepend(k({post:b[c],settings:d}))}))}))},800),""==c&&(a(m).children().remove(),g(e),h.parent().css("opacity",0))}).on("click","#lasso--search__toggle",function(b){b.preventDefault(),a(this).closest(".lasso--search").toggleClass("lasso--search__visible")})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 0499b61... search the object in view, stock posts and pages
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(n).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,B=capable?h(b,w):h(b,w,lasso_editor.author),y=new wp.api.collections.Pages(B)):(capable=lasso_editor.edit_others_posts,B=capable?h(b,w):h(b,w,lasso_editor.author),y=new wp.api.collections.Posts(B)),y.fetch(B).done(function(){if(a("#lasso--load-more").remove(),y.length>0){var c=y.state.currentPage;c-=1;var g=a('<div data-page-num="'+y.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');y.each(function(a){g.append(l({post:a.attributes,settings:d}))}),a(n).append(g),a(n).append(v),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(n).append(s),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return B={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}function i(b){a(n).children().remove(),g(b),a(".lasso--search input").val("").focusout(),a("#lasso--results-found").parent().css("opacity",0)}var j,k=a("#lasso-tmpl--post"),l=c.template(k.html()),m=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),n="#lasso--post-list",o=lasso_editor.strings.loading,p=lasso_editor.strings.loadMore,q=lasso_editor.strings.noPostsFound,r=a("body"),s='<li id="lasso--end-posts">'+q+"</li>",t=lasso_editor.noResultsDiv,u='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',v='<a href="#" id="lasso--load-more">'+p+"</a>",w=1,x="post",y=!1,z=null,A=d.root,B={data:{page:w,filter:{post_status:["publish","draft","pending"]}}};a(m).on("click",function(a){a.preventDefault(),r.toggleClass("lasso-modal-open"),r.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(r).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(o),w++,x=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),w=1,z=null,a("#lasso--load-more").attr("data-post-type",type),a(n).prepend(u),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){clearTimeout(j);var b=this,c=a(this).val(),e=a(".active.lasso--show-objects").data("post-type"),f=A+"/"+e+"s?filter[s]="+c,g=a("#lasso--results-found");j=setTimeout(function(){c.length>=3&&c==a(b).val()&&(a(n).prepend(u),a.getJSON(f,function(b){a(n).children().remove(),g.parent().css("opacity",1),0==b.length?(g.text("0"),a("#lasso--empty-results").length||a(n).prepend(t)):(g.text(b.length),a.each(b,function(c){a(n).prepend(l({post:b[c],settings:d}))}))}))},800),""==c&&i(e)}).on("click","#lasso--search__toggle",function(b){b.preventDefault(),a(".lasso--search").toggleClass("lasso--search__visible").find("input").focus(),a(this).parent().hasClass("lasso--search__visible")||i("post")})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> fbff8a5... when search is toggled auto focus field, destroySearch helper function
=======
};a(".ase-gallery-type-radio").each(function(){if(a(this).is(":checked")){a(this).parent().addClass("selected");var c=a(this).val();b(c)}}),a(".ase-gallery-layout-label").live("click",function(){a(".ase-gallery-layout-label").removeClass("selected"),a(this).addClass("selected");var c=a(this).find("input").val();b(c),a("#ase_gallery_type").val(c)})})}(jQuery),function(a){a("#lasso--map-form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val("Saving...").addClass("being-saved");var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(a){1==a.success?(c.find('input[type="submit"]').val("Saved"),c.removeClass("being-saved").addClass("lasso--saved"),setTimeout(function(){c.find('input[type="submit"]').val("Save Locations").removeClass("lasso-saved")},1200)):c.removeClass("being-saved").addClass("lasso--error")})})}(jQuery),function(a){"use strict";a("#lasso--featImgSave a").live("click",function(b){b.preventDefault();var c=a(this),d=a("#lasso--save-status"),e={action:"process_upload-image_upload",postid:lasso_editor.postid,image_id:c.data("featimg-id"),nonce:lasso_editor.featImgNonce};d.removeClass("not-visible").addClass("visible lasso--animate__spin"),a.post(lasso_editor.ajaxurl,e,function(b){b&&(console.log("response"),a("#lasso--featImgSave").css("opacity",0),d.removeClass("lasso--animate__spin lasso-icon-spinner6").addClass("lasso-icon-check"),setTimeout(function(){d.removeClass("lasso--animate__spin lasso-icon-check").addClass("lasso-icon-spinner6 not-visible")},500))})});var b,c;a(document).on("click","#lasso--featImgUpload > a",function(d){d.preventDefault(),c=d.currentTarget.parentElement.className;var e=a("#lasso--featImgSave a");return b?void b.open():(b=wp.media.frames.file_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),b.on("select",function(){var c=b.state().get("selection").first().toJSON();a("body").addClass("lasso--post-thumb-applied"),a("article").removeClass("no-post-thumbnail").addClass("has-post-thumbnail"),a(lasso_editor.featImgClass).css({"background-image":"url("+c.url+")"}),e.attr("data-featimg-id",c.id).trigger("click"),a(".no-post-cover-note").remove()}),void b.open())}),a(document).on("click","#lasso--featImgDelete > a",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){1==b.success&&(a("body").addClass("lasso--post-thumb-removed"),a("article").removeClass("has-post-thumbnail").addClass("no-post-thumbnail"),a("#lasso--featImgDelete").addClass("lasso--featImg--controlHidden"),c.closest("ul").removeClass("lasso--featImg--has-thumb"),a(lasso_editor.featImgClass).css({"background-image":"url()"}))})})});var d;a(document).on("click","#lasso--post-thumb__add",function(b){b.preventDefault();var c=a(this),e=a("#lasso--featImgSave a");return d?void d.open():(d=wp.media.frames.featimg_frame=wp.media({title:lasso_editor.strings.chooseImage,button:{text:lasso_editor.strings.updateImage},multiple:!1}),d.on("select",function(){var b=d.state().get("selection").first().toJSON();c.closest(".lasso--post-thumb").find("img").attr("src",b.url),e.attr("data-featimg-id",b.id).trigger("click"),a("#lasso--postsettings__form").removeClass("no-thumbnail").addClass("has-thumbnail")}),void d.open())}).on("click","#lasso--post-thumb__delete",function(b){b.preventDefault();var c=a(this),d={action:"process_upload-image_delete",postid:lasso_editor.postid,nonce:lasso_editor.featImgNonce};swal({title:lasso_editor.strings.removeFeatImg,type:"warning",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){a.post(lasso_editor.ajaxurl,d,function(b){if(1==b.success){var d=c.closest(".lasso--post-thumb").data("default-thumb");c.closest(".lasso--postsettings__left").find("img").attr("src",d),a("#lasso--postsettings__form").removeClass("has-thumbnail").addClass("no-thumbnail")}})})})}(jQuery),function(a){a("#lasso--component-settings-form").live("submit",function(b){b.preventDefault();var c=window.component,d=c.data(),e=a("#lasso-generator-insert"),f=a("#lasso--component-settings-form"),g=a(this);e.val(lasso_editor.strings.saving),g.find(".lasso-generator-attr").each(function(){var b=a(this).closest(".lasso-option").data("option");""!==a(this).val()&&(c.attr("data-"+b,a(this).val()),c.data(b,a(this).val()))});var h=function(a){return delete a.sortableItem,a},i=function(b,c,d){var g=function(a){e.addClass("saved"),e.val(1==a?lasso_editor.strings.galleryCreated:lasso_editor.strings.saved)};1==b?setTimeout(function(){g()},500):1==d?(f.addClass("hide-all-fields").prepend('<div id="lasso--pagerefresh">Gallery Created! Save your post and refresh the page to access this new gallery.</div>'),setTimeout(function(){g(!0)},500)):g(),setTimeout(function(){a("body").removeClass("lasso-sidebar-open")},c)};if("gallery"==d.componentType){var j={action:f.hasClass("creating-gallery")?"process_gallery_create":"process_gallery_update",postid:lasso_editor.postid,unique:d.unique,fields:h(d),gallery_type:a("#ase_gallery_type").val(),gallery_ids:a("#ase_gallery_ids").val(),nonce:a("#lasso-generator-nonce").val()};a.post(lasso_editor.ajaxurl,j,function(a){"gallery-created"==a.data.message?i(!1,4e3,!0):"gallery-updated"==a.data.message?(i(!1,4e3),f.before(lasso_editor.refreshRequired)):alert("error")})}else i(!0,1200)})}(jQuery),function(a){a(document).ready(function(){var b=function(){a("body").removeClass("lasso-modal-open"),a(".lasso--modal, #lasso--modal__overlay").remove()};a("#lasso--post-new").live("click",function(b){b.preventDefault(),a("body").toggleClass("lasso-modal-open"),a("body").append(lasso_editor.newPostModal);var c=a(".url-helper"),d=c.outerWidth(),e=a('input[name="story_title"]'),f=342;e.css({width:f-d}),a(".lasso--modal__trigger-footer").on("keyup",function(){a(".lasso--postsettings__footer").slideDown()}),modalResizer()}),a("#lasso--modal__close, #lasso--modal__overlay, .lasso--postsettings-cancel").live("click",function(a){a.preventDefault(),b()}),a(document).keyup(function(a){27==a.keyCode&&b()});a("#lasso--postnew__form").live("submit",function(b){b.preventDefault();var c=a(this);a(this).find('input[type="submit"]').val(lasso_editor.strings.adding);var d=c.serialize();a.post(lasso_editor.ajaxurl,d,function(b){1==b.success?(a('input[type="submit"]').addClass("saved"),a('input[type="submit"]').val(lasso_editor.strings.added),window.location.replace(b.data.postlink)):alert("error")})})})}(jQuery),function(a){a(document).ready(function(){a(lasso_editor.titleClass).on("blur",function(){var b=a(this),c={action:"process_title-update_post",postid:lasso_editor.postid,title:a.trim(b.text()),nonce:lasso_editor.titleNonce};a.post(lasso_editor.ajaxurl,c,function(a){if(1==a.success){var c="lasso-title-saved";b.addClass(c),setTimeout(function(){b.removeClass(c)},500)}})})})}(jQuery),function(a){a(document).ready(function(){var b,c;a(document).on("click","#lasso--wpimg-edit",function(d){d.preventDefault();var e=a(this),f=a(this).parent().next("img").attr("class").match(/\d+/);c=d.currentTarget.parentElement.className,b=wp.media.frames.ase_edit_frame=wp.media({title:lasso_editor.strings.selectImage,button:{text:lasso_editor.strings.insertImage},multiple:!1}),b.on("open",function(){var a=b.state().get("selection"),c=wp.media.attachment(f);c.fetch(),a.add(c?[c]:[])}),b.on("select",function(){var c=b.state().get("selection").first().toJSON(),d=void 0===c.sizes.large?c.sizes.full.url:c.sizes.large.url;a(e).parent().next("img").attr({src:d,alt:c.alt,"class":"aligncenter size-large wp-image-"+c.id})}),b.open()})})}(jQuery),function(){jQuery(document).ready(function(a){modalResizer=function(){var b=a(".lasso--modal"),c=b.height(),d=a(window).height(),e=a(".lasso--modal").hasClass("lasso--tour__modal")?0:30;b.css({top:(d-c-e)/2})},a(".lasso--modal").imagesLoaded(function(){modalResizer()}),jQuery(window).resize(function(){modalResizer()})})}(jQuery),function(a,b,c,d){function e(){a("#lasso--loading").remove()}function f(){a(n).perfectScrollbar({suppressScrollX:!0})}function g(b){"page"==b?(capable=lasso_editor.edit_others_pages,B=capable?h(b,w):h(b,w,lasso_editor.author),y=new wp.api.collections.Pages(B)):(capable=lasso_editor.edit_others_posts,B=capable?h(b,w):h(b,w,lasso_editor.author),y=new wp.api.collections.Posts(B)),y.fetch(B).done(function(){if(a("#lasso--load-more").remove(),y.length>0){var c=y.state.currentPage;c-=1;var g=a('<div data-page-num="'+y.state.currentPage+'" class="lasso--object-batch" id="lasso--object-batch-'+c+'"></div>');y.each(function(a){g.append(l({post:a.attributes,settings:d}))}),a(n).append(g),a(n).append(v),a(".lasso--post-filtering").removeClass("not-visible").addClass("visible"),a("#lasso--load-more").attr("data-post-type",b).removeClass("lasso--btn-loading"),f()}else a(n).append(s),setTimeout(function(){a("#lasso--end-posts").fadeOut("slow")},1e3);e()})}function h(a,b,c){return B={data:{page:b,type:a,filter:{post_status:["publish","draft","pending"],posts_per_page:7,author:c}}}}function i(b){a(n).children().remove(),g(b),a(".lasso--search input").val("").focusout(),a("#lasso--results-found").parent().css("opacity",0)}var j,k=a("#lasso-tmpl--post"),l=c.template(k.html()),m=(new wp.api.collections.Posts,new wp.api.collections.Pages,a("#lasso--post-all")),n="#lasso--post-list",o=lasso_editor.strings.loading,p=lasso_editor.strings.loadMore,q=lasso_editor.strings.noPostsFound,r=a("body"),s='<li id="lasso--end-posts">'+q+"</li>",t=lasso_editor.noResultsDiv,u='<div id="lasso--loading" class="lasso--loading"><div class="lasso--loader"></div></div>',v='<a href="#" id="lasso--load-more">'+p+"</a>",w=1,x="post",y=!1,z=null,A=d.root,B={data:{page:w,filter:{post_status:["publish","draft","pending"]}}};a(m).on("click",function(a){a.preventDefault(),r.toggleClass("lasso-modal-open"),r.append(lasso_editor.allPostModal),g("post"),modalResizer()}),a(r).on("click","#lasso--load-more",function(b){b.preventDefault(),type=a(this).attr("data-post-type"),a(this).addClass("lasso--btn-loading").text(o),w++,x=type,g(type)}).on("click",".lasso--show-objects",function(b){b.preventDefault(),a(".lasso--show-objects").removeClass("active"),a(this).addClass("active"),a("#lasso--post-list").empty(),type=a(this).data("post-type"),w=1,z=null,a("#lasso--load-more").attr("data-post-type",type),a(n).prepend(u),g(type)}).on("click","#lasso--post__delete",function(b){b.preventDefault();var c=a(this);swal({title:lasso_editor.strings.deletePost,type:"error",text:!1,showCancelButton:!0,confirmButtonColor:"#d9534f",confirmButtonText:lasso_editor.strings.deleteYes,closeOnConfirm:!0},function(){var b={action:"process_delete_post",postid:c.closest("a").data("postid"),nonce:lasso_editor.deletePost};a.post(lasso_editor.ajaxurl,b,function(a){1==a.success&&c.closest("li").fadeOut().remove()})})}).on("keyup",".lasso--search input",function(){clearTimeout(j);var b=this,c=a(this).val(),e=a(".active.lasso--show-objects").data("post-type"),f=A+"/"+e+"s?filter[s]="+c,g=a("#lasso--results-found");j=setTimeout(function(){c.length>=3&&c==a(b).val()&&(a(n).prepend(u),a.getJSON(f,function(b){a(n).children().remove(),g.parent().css("opacity",1),0==b.length?(g.text("0"),a("#lasso--empty-results").length||a(n).prepend(t)):(g.text(b.length),a.each(b,function(c){a(n).prepend(l({post:b[c],settings:d}))}))}))},600),""==c&&i(e)}).on("click","#lasso--search__toggle",function(b){b.preventDefault();var c=a(".lasso--search input");a(".lasso--search").toggleClass("lasso--search__visible"),c.focus(),a(this).parent().hasClass("lasso--search__visible")||""===c.val()||i("post")})}(jQuery,Backbone,_,WP_API_Settings),function(a){a(document).ready(function(){destroyModal=function(){a("body").removeClass("lasso-modal-open"),a("#lasso--tour__modal,#lasso--tour__modal ~ #lasso--modal__overlay").remove()},a('#lasso--tour__modal input[type="submit"]').live("click",function(b){b.preventDefault();a(this);if(a("#hide_tour").is(":checked")){var c={action:"process_tour_hide",nonce:a(this).data("nonce")};a.post(lasso_editor.ajaxurl,c,function(a){1==a.success&&destroyModal()})}else destroyModal()})})}(jQuery);
>>>>>>> 7ebdbc2... design empty state for no post results, only destroy seatrch if value isn't empty
