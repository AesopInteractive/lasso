...
jQuery(document).ready(function($){
	...
	$('#lasso--edit').click(function(e){
		...
		//$( '.lasso-toolbar--strike' ).wpColorPicker();
		$( '#color-picker' ).iris();
		...
		$(".iris-picker").css({position:'absolute', top:-200});
		$("#color-picker").iris({
			palettes: true,
			change: function(event, ui) {
				...
				// change the color
				$("#color-picker").css( 'color', ui.color.toString());
			}
		});
			
		$('#color-picker').mousedown(function(event) {
		...
		$('#color-set').mousedown(function() {
			articleMedium.element.contentEditable = true;
			article.highlight();
			var colorVar = rgb2hex($('#color-picker').css("color"));
			articleMedium.invokeElement('span', { style: 'color:' + colorVar + ';'});
			return false;
		});
		
		$('#right-align').mousedown(function() {
			var focusedElement = articleMedium.html.textElementAtCaret();
			if (focusedElement) {
		...
		$('#center-align').mousedown(function() {
			var focusedElement = articleMedium.html.textElementAtCaret();
			if (focusedElement) {
